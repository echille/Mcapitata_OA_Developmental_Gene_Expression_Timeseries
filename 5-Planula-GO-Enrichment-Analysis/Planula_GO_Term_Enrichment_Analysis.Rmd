...
Testing overlap of KO goseq results with original Mcap annotation
```{r}
#KOdfwithIPS <- KOdf
...
#nrow(KOdf)
# nrow(KOdfwithIPS)
# intersect(KOdf$category, IPS.KO$ko)
# intersect(IPS.KO$ko, KOdf$category)

# KOdf
# KOdfwithIPS
# all(KOdf$category==KOdfwithIPS$category)
# all(KOdf$over_represented_pvalue==KOdfwithIPS$over_represented_pvalue)
# all(KOdf$numDEInCat==KOdfwithIPS$numDEInCat)
# all(KOdf$numInCat==KOdfwithIPS$numInCat)
# all(KOdf$dir==KOdfwithIPS$dir)
# all(KOdf$genes==KOdfwithIPS$genes)

# setdiff(KOdf$category,KOdfwithIPS$category)
# setdiff(KOdf$over_represented_pvalue,KOdfwithIPS$over_represented_pvalue)
# setdiff(KOdf$numDEInCat,KOdfwithIPS$numDEInCat)
# setdiff(KOdf$numInCat,KOdfwithIPS$numInCat)
# setdiff(KOdf$dir,KOdfwithIPS$dir)
# setdiff(KOdf$genes,KOdfwithIPS$genes)

# setdiff(KOdfwithIPS$category,KOdf$category)
# setdiff(KOdfwithIPS$over_represented_pvalue,KOdf$over_represented_pvalue)
# setdiff(KOdfwithIPS$numDEInCat,KOdf$numDEInCat)
# setdiff(KOdfwithIPS$numInCat,KOdf$numInCat)
# setdiff(KOdfwithIPS$dir,KOdf$dir)
# setdiff(KOdfwithIPS$genes,KOdf$genes)

# KOdfwithIPS.noK07937 <- filter(KOdfwithIPS, category!="K07937")
# all(KOdf$category==KOdfwithIPS.noK07937$category)
# all(KOdf$over_represented_pvalue==KOdfwithIPS.noK07937$over_represented_pvalue)
# all(KOdf$numDEInCat==KOdfwithIPS.noK07937$numDEInCat)
# all(KOdf$numInCat==KOdfwithIPS.noK07937$numInCat)
# all(KOdf$dir==KOdfwithIPS.noK07937$dir)
# all(KOdf$genes==KOdfwithIPS.noK07937$genes)
```
