...
gcount <- as.data.frame(read_delim(file = "6-Symbiont-RNAseq-Analysis/a-QC-Align-Assemble/Trinity/RSEM.isoform.counts.matrix.tsv", delim = "\t"))
rownames(gcount) <- gcount$X1
gcount$X1 <- NULL
head(gcount)
nrow(gcount)
gcount <- round(gcount) # round the gene counts matrix
t2g <- read.csv("6-Symbiont-RNAseq-Analysis/b-Differential-Gene-Expression-Analysis/pln_matrix_ids.csv", header = TRUE, sep = ",")
