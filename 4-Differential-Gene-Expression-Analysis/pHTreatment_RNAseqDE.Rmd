...
pln_pca <- ggplot(gPCAdata_pln, aes(PC1, PC2, color=treatment)) + 
  geom_point(size=3) +
  ...
  theme(panel.border = element_blank(), # Set border
        ...
        axis.text = element_text(size = 12)) ; pln_pca #Axis text size; view plot

#ggsave(file = "4-Differential-Gene-Expression-Analysis/Output/Fig2-planula-PCA.png", pln_pca, width = 7.5/2, height = 11/2, units = "in")
```
...
pln_DEGheatmap <-  Heatmap(matpln, column_title = "Treatment", 
  ...
  Heatmap(hm_ann_row, name = "cluster", show_row_names = FALSE, width = unit(5, "mm"), col = c("#4682B4", "#B47846")); pln_DEGheatmap
